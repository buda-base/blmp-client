...
export const shapeRefsMap: Record<string, RDFResourceWithLabel> = {
  ...
  "bds:WorkShape": new ExtRDFResourceWithLabel(ns.BDS("WorkShape").value, { en: "Work (Conceptual)" }),
...
export const bdsDisplayPriority = ns.RDE("displayPriority") as rdf.NamedNode
...
export const bdsPropertyShapeType = ns.RDE("propertyShapeType") as rdf.NamedNode
export const bdsFacetShape = ns.RDE("InternalShape") as rdf.NamedNode
export const bdsExternalShape = ns.RDE("ExternalShape") as rdf.NamedNode
export const bdsIgnoreShape = ns.BDS("IgnoreShape") as rdf.NamedNode
export const bdsClassIn = ns.RDE("classIn") as rdf.NamedNode
...
export const bdsReadOnly = ns.RDE("readOnly") as rdf.NamedNode
export const bdsIdentifierPrefix = ns.RDE("identifierPrefix") as rdf.NamedNode
export const bdsAllowMarkDown = ns.RDE("allowMarkDown") as rdf.NamedNode
export const shNamespace = ns.SH("namespace") as rdf.NamedNode
export const bdsDefaultLanguage = ns.RDE("defaultLanguage") as rdf.NamedNode
export const bdsDefaultValue = ns.RDE("defaultValue") as rdf.NamedNode
export const shLanguageIn = ns.SH("languageIn") as rdf.NamedNode
export const shPattern = ns.SH("pattern") as rdf.NamedNode
export const bdsSortOnProperty = ns.RDE("sortOnProperty") as rdf.NamedNode
export const bdsAllowPushToTopLevelSkosPrefLabel = ns.RDE("allowPushToTopLevelLabel") as rdf.NamedNode
export const bdsIndependentIdentifiers = ns.RDE("independentIdentifiers") as rdf.NamedNode
export const bdsSpecialPattern = ns.RDE("specialPattern") as rdf.NamedNode
export const bdsConnectIDs = ns.RDE("connectIDs") as rdf.NamedNode
export const bdsAllowBatchManagement = ns.RDE("allowBatchManagement") as rdf.NamedNode
export const bdsCopyObjectsOfProperty = ns.RDE("copyObjectsOfProperty") as rdf.NamedNode
export const bdsUniqueValueAmongSiblings = ns.RDE("uniqueValueAmongSiblings") as rdf.NamedNode
